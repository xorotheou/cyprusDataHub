    ...
    >
      ...
      <div className="p-5 border-b border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Portal & API Directory</p>
          </div>
        </div>
        ...
        <div className="mt-4 relative">
          ...
          <input
            ...
            type="text"
            placeholder="Filter categories or APIs..."
            value={searchQuery}
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2 space-y-1">
        <div className="px-2 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-slate-400">
          Core Domains ({totalDatasets} Datasets)
        </div>
      ...
      <div className="p-4 border-t border-slate-800 text-[11px] text-slate-400 bg-slate-950/40 space-y-2">
        <div className="flex items-center gap-1.5 text-slate-400">
          ...
          <span>Official Public Sources & APIs</span>
        </div>
